...
# ✏️ 서론
---
개발자로서 오픈소스에 기여하는 일은 언젠가 꼭 해보고 싶은 목표 중 하나였지만, 어디서부터 시작해야 할지 막막한 게 현실이었습니다.

그러던 중, 오픈 소스 기여하는 방법을 가이드 해주는 커뮤니티를 알게 되었습니다.

그곳에서 멘토링에 참여하게 되었고, 이슈 선정부터 

그러던 중, Kafka에 대해 공부하던 어느 날, 문득 Spring Kafka의 내부 구현이 궁금해져 소스코드를 살펴보게 되었고, 자연스럽게 GitHub 저장소까지 들어가게 되었습니다.
...
처음에는 Apache Jackrabbit Oak 의 이슈를 찾을 수 있었습니다. 아래에서 자세하게 설명하겠지만, 결론적으로 해당 PR 은 Merge 에 실패하였고, 다시 여러 이슈를 찾기 시작하였습니다.

그 결과, [KafkaTemplate Bean 이름 불일치 이슈](https://github.com/spring-projects/spring-kafka/issues/3514) 를 찾을 수 있게 되었습니다.

## 📚 이슈 : KafkaTemplate Bean 이름 불일치
---
...
## 🤣 배움 : Apache Jackrabbit Oak 기여 실패 경험
---
